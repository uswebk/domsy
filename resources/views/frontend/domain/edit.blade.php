...
@section('content')
  <div class='container m-0'>
    ...
    <div class='w-100 mt-2'>
      ...
      <div>
        {{ Form::select('registrar_id', $registrarIds, old('registrar_id', $domain->registrar_id), ['placeholder' => 'Select Registrar', 'id' => 'domain-registrar_id', 'class' => 'form-control w-50 d-inline']) }}
      </div>
